...
interface Property {
  ...
  type?:
    ...
    | "file"
    | "object"
    | "class"; // Type of the property (string (default), int, float, bool, color, file, object or class (since 0.16, with color and file added in 0.17, object added in 1.4 and class added in 1.8))
...
interface TiledTileset {
  ...
  objectalignment?:
    ...
    | "bottomleft"
    | "bottom"
    | "bottomright"; // Alignment to use for tile objects (unspecified (default), topleft, top, topright, left, center, right, bottomleft, bottom or bottomright) (since 1.4)
  properties: Property[]; // Array of Properties
